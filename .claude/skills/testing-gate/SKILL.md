---
name: testing-gate
description: Required verification per change type for job-hunter (pure module → unit test, fetcher → smoke run, schema → hand-written migration, dashboard → rebuild + screenshot). Read before implementing any feature and before every commit.
---
