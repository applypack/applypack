...
- **Find real jobs.** 29 sources hourly, a classifier with strict stack
...
```
 29 sources ──▶ normalize ──▶ base filter ──▶ AI classifier ──▶ Postgres ──▶ Telegram
...
- **Direct boards**: Greenhouse, Lever, Ashby, Workable, SmartRecruiters, Personio
