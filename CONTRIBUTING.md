...
Thanks for helping. job-hunter is a small, sharp codebase: TypeScript
...
- **Add a job source.** The highest-value contribution and close to a
  ...
  source qualifies? Open a [source proposal](https://github.com/nazboyko/job-hunter/issues/new?template=new_source.yml)
  first.
